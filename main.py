...
def calculate_bezier_curve():
    ...
    for t in range(101):
        t_normalized = t / 100
        point = calculate_bezier_point(t_normalized, control_points)
...
def main():
    ...
    get_input_coordinates("Control Point 4 (x, y): ")
    ...
    while True:
        ...
        # Get mouse position and update the fourth control point
        mouse_x, mouse_y = pygame.mouse.get_pos()
        control_points[3] = ((mouse_x - ORIGIN_X) / SCALE_FACTOR, (ORIGIN_Y - mouse_y) / SCALE_FACTOR)
